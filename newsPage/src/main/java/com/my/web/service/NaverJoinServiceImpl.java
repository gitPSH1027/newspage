...
public class NaverJoinServiceImpl implements NaverJoinService {
	...
	public Map<String, String> getApiURl() throws Exception {
		...
		// window 콜백주소
		// String redirectURI =
		// URLEncoder.encode("http://localhost:8081/web/naver_callback", "UTF-8");

		// 서버 콜백주소
		String redirectURI = URLEncoder.encode("http://49.50.174.40:8080/newsPage/naver_callback", "UTF-8");
